...
def litCricFriend(wordList, text):
    ...
    # One line of code.
    text_mdash_replace = text_lower.replace("--", " ")
    ...
    text_split = text_mdash_replace.split()
    ...
    # Three lines of code.
    text_stripped = []
    for i in " ".join(text_split):
        if i not in string.punctuation:
            text_stripped.append(i)
    text_joined = "".join(text_stripped)
    text_strip_2 = text_joined.split()
    ...
    count = []
    for i in wordList:
        count.append(text_strip_2.count(i))
    ...
    ratio = []
    for i in count:
        ratio.append(int(i)/len(text_strip_2))
    print(ratio)
...
print("theBells \"a\" and \"an\": ", end = "")
litCricFriend(wordList, theBells)

print("theBells \"the\": ", end = "")
litCricFriend(wordList2, theBells)

print("cantoXII \"a\" and \"an\": ", end = "")
litCricFriend(wordList, cantoXII)

print("cantoXII \"the\": ", end = "")
litCricFriend(wordList2, cantoXII)

# PROBLEM 8
# Poe uses more 'a' and no 'an' articles while Neruda uses less 'a' and more 'an' articles than Poe.
# Poe uses significantly more 'the' articles than Neruda.
